app.directive('datepickerFullNew', [function () {
    return {
        restrict: 'E',
        scope: {
            'isValidate': '@',
        ...
        templateUrl: 'app/shared/Directives/DatePicker2/datepicker2.html',
        replace: true,
        controller: ['$scope', function ($scope) {
            var vm = $scope;
            vm.showValidate = false;
            vm.isRequired = false;
            vm.Format = 'dd/MM/yyyy HH:mm:ss';
    ...
    function toyyyyMMdd(date) {
        ...
        var mmm = dateNow.getMinutes();
        return yyyy + "-" + (mm[1] ? mm : "0" + mm[0]) + "-" + (dd[1] ? dd : "0" + dd[0]) + " " + hh + ":" + mmm + ":01";
    }
